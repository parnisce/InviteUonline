...
const faqs = [
    ...
    { q: 'Can I use my own domain name?', a: 'Yes! Pro and Business plans allow you to connect your custom domain so your RSVP page appears on yourname.com instead of inviteuonline.vercel.app.', category: 'Customization' },
